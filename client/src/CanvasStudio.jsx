...
import { Type, Image as ImageIcon, Video, Mic, Download, Trash2, Sliders, FileText, Music, Play, Captions, Save, Upload, Layers } from 'lucide-react';
...
export default function CanvasStudio() {
  ...
  const exportCanvasToMp4 = async () => {
    ...
    try {
      ...
      const videoUrl = `http://localhost:5000/outputs/${res.data.file}`;
  ...
  return (
    <div style={{ display: 'flex', height: '100vh', fontFamily: 'sans-serif', backgroundColor: '#f1f5f9' }}>
      ...
      <div style={{ flex: 1, padding: '20px', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
        <div style={{ marginBottom: '10px', color: '#334155', fontWeight: 'bold' }}>
        ...
        {/* Video Timeline Scrub Bar (UI Polish) */}
        <div style={{ marginTop: '15px', width: '800px', backgroundColor: '#1e293b', padding: '15px', borderRadius: '8px', color: '#fff', display: 'flex', flexDirection: 'column', gap: '8px' }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
            ...
            <span style={{ fontSize: '12px', color: '#38bdf8' }}>00:00:{String(timelineSec).padStart(2, '0')} / 00:00:30</span>
          </div>
          <input 
            type="range" 
            min="0" 
        ...
        {transcriptionText && (
          <div style={{ marginTop: '15px', width: '800px', backgroundColor: '#fff', padding: '15px', borderRadius: '8px', border: '1px solid #e2e8f0' }}>
