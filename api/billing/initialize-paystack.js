// omnistudio-canvas/api/billing/initialize-paystack.js
const axios = require('axios');

function resolveGeoLocalization(req, timeZone) {
...
module.exports = async (req, res) => {
  ...
  try {
    ...
    const callPaystackApi = async (curr) => {
    ...
    try {
      ...
      const errMsg = (firstErr.response && firstErr.response.data && firstErr.response.data.message) || '';
    ...
    console.error('[Vercel Paystack Init Error]:', err.response ? err.response.data : err.message);
    const paystackErrorMsg = (err.response && err.response.data && err.response.data.message)
